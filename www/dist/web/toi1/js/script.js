...
var result_suc =function(){
    ...
    keypad.remove();
    count_char.remove();
    document.getElementById('main_question').innerHTML="<h1 id='result'>手がかりを１つ掴んだ。<br>次の手がかりを探しに行こう。</h1>";
}
...
function enter(){
    ...
    if(document.getElementById("answer_1").textContent=="な"){
        if(document.getElementById("answer_2").textContent=="が"){
            if(document.getElementById("answer_3").textContent=="れ"){
                if(document.getElementById("answer_4").textContent=="ぼ"){
                    if(document.getElementById("answer_5").textContent=="し"){
                        result_suc();
                        return;
                    }else{
                        failaudio.play();
...
var page=0;
function page_slide_next(){
    page++;
    if(page>2){
        page=2;
    }
    switch(page){
        case 0:document.getElementById("toi_img").src="./image/問題１_本編.png";
        break;
        case 1:document.getElementById("toi_img").src="./image/diary.png";
        break;
        case 2:document.getElementById("toi_img").src="./image/diary_2.png";
        break;
    }    
}
function page_slide_back(){
    page--;
    if(page<0){
        page=0;
    }
